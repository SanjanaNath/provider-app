          ...
          Flexible(
            child: TextFormField(
              ...
              decoration: InputDecoration(
                ...
                errorStyle: errorStyle ?? const TextStyle(color: Colors.white),
                helperStyle: hintStyle,
                labelText: labelText,
                fillColor: fillColor ?? Colors.white.withOpacity(0.3),
                filled: filled ?? true,
                labelStyle: labelStyle ??
                    const TextStyle(fontWeight: FontWeight.w400, fontSize: 16, color: Colors.white),
                hintStyle: hintStyle ??
                    TextStyle(
                ...
                contentPadding: contentPadding ?? const EdgeInsets.fromLTRB(18, 14, 8, 14),
